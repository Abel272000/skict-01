...
if __name__ == "__main__":
    ...
    dt_incidencia = dt_heart['INCIDENCIA']

    # Normalizamos los datos
    dt_features = StandardScaler().fit_transform(dt_features)
    # Partimos el conjunto de entrenamiento y para añadir replicabilidad usamos el random state
    
    X_train, X_test, y_train, y_test = train_test_split(dt_features, dt_incidencia, test_size=0.3, random_state=42)
    ...
    for k in kernel:
        ## importamos
        kpca = KernelPCA(n_components=5, kernel = k)
