...
if __name__ == '__main__':
    ...
    ##algoritmo PCA
    lineal=LinearRegression()##de las 13 columnas solo ocupamos 3 columnas artificiales..?? variables artificiales
    ...
    plt.plot(range(len(lineal.explained_variance_)),lineal.explained_variance_ratio_) #gneera desde 0 hasta los componentes
    #plt.show() #---grafica----
    ...
    dt_train = lineal.transform(X_train)#conjunto de entrenamiento 
    dt_test = lineal.transform(X_test)#conjunto de prueba
    ...
    ##
    print("SCORE lineal: ", logistic.score(dt_test, y_test))##internamente imprimo la prediccion y se envia los datos de entremaiento
