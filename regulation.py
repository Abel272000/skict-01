...
if __name__ == "__main__":
    ...
    X = dataset[['Tconfirmacion','Tconfir_dia',
                 'Confir_A','Confirmadas',
                 'Peso_Confing','Clases',
                 'Ncloc','Funciones',
                 'Lineas_Dupli','Error_P',
                 'Pruebas_Omit','Covertura',
                 'Complejidad','Lineas_Coment',
                 'Densidad_LC','Densidad_LD',
                 'Archivos','Directorios',
                 'Complejidad_Archi','Violaciones',
                 'Bloques_Dupli','Archivos_Dupli',
                 'Lineas','Pblic_Api',
                 'Declaraciones','Violaciones_Bloquea',
                 'Violaciones_Criticas','Violaciones_Mayores',
                 'Violaciones_Menores','Violaciones_Info',
                 'Lineas_Cubrir','Cobertura_Linea',
                 'Condiciones_Cubrir','C_Sucursales',
                 'Indice_Escala','Calificacion_Es',
                 'P_Falsos_Positivos','Problem_Abiertos',
                 'Problem_Rabiertos','P_Confirmados',
                 'R_Deuda_Cuadrada','R_Deuda_Nescala',
                 'Codgio_Huele','N_Cod_Huele',
                 'Insectos','Calificacion_Mantenimiento',
                 'E_Remediacion_Conf','Calificacion_Confiabi',
                 'E_Re_Seguridad','Calif_Seguri',
                 'Conplejidad_Cognitiva','N_Cost_Desarrollo',
                 'P_Acceso_Seg','Calif_Revis_Seg']]
